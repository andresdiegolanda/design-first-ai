...
> For story writing: `/business-story-narration`
...
- Skills follow the Copilot agent skills convention: `{name}/SKILL.md` in a skills directory
- Skills in `context/skills/` stay stack-agnostic — framework-specific patterns belong in `.github/skills/`
...
| Skills | `context/skills/{name}/SKILL.md` | `context/skills/error-handling/SKILL.md` |
...
│   └── skills/                          ← reusable agent skills (stack-agnostic)
...
│   │   ├── .github/skills/              ← project-specific agent skills
...
- Do not add framework-specific skills to `context/skills/` — they belong in project `.github/skills/`
- Do not create new examples with `conversation/` or `outcome.md` — use `docs/` story documents
- Do not reference `context/skills/skill-*.md` — skills moved to `context/skills/{name}/SKILL.md`
